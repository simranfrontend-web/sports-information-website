...
<body>
    ...
    <div class="p-5 bg-primary text-white text-center">
        <img src="./images/rugby-2.jpg" class="w-100"alt="">
        <h1>Rugby Union World Cup</h1>
        <p1>The Rugby World Cup is the women's/Men's rugby union world championship which is organised by World Rugby.
        </p1>
    </div>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <h2 class="mt-5">Rugby</h2>

                <div>
                    <iframe width="1200" height="315" src="https://www.youtube.com/embed/Y-trs1AZl4k"
                        title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        allowfullscreen></iframe>
                </div>
                <h2>Rugby World Cup (women)</h2>
                <hr><br>
                ...
                <img src="./images/Rugby_night.jpg" class="w-100" alt="">
